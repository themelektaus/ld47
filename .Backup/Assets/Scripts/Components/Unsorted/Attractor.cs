...
namespace MT.Packages.LD47
{
	public class Attractor : MonoBehaviour
	{
		...
		public Core.SmoothFloat rotation;
		...
		void Awake() {
			...
			rotation = new Core.SmoothFloat(() => body.rotation, x => body.SetRotation(x), .1f);
		}
		...
		public float GetAngle() {
			...
			var angle = Utility.GetAngle2D(transform.position, gravitation.position);
